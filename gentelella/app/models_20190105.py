...
class Chapter(models.Model):
    ...
    editionid = models.ForeignKey('Edition', models.DO_NOTHING, db_column='editionId')  # Field name made lowercase.
    chapter = models.CharField(max_length=255, blank=True, null=True)
    unit = models.CharField(max_length=255, blank=True, null=True)
    section = models.CharField(max_length=255, blank=True, null=True)
    knowledgeid = models.ForeignKey('KnowledgeBasic', models.DO_NOTHING, db_column='knowledgeId', blank=True, null=True)  # Field name made lowercase.
...
class Paper(models.Model):
    ...
    chapterid = models.ForeignKey(Chapter, models.DO_NOTHING, db_column='chapterid', blank=True, null=True)
    papertypeid = models.ForeignKey('Papertype', models.DO_NOTHING, db_column='papertypeid', blank=True, null=True)
